...
import 'package:digital_logic_sim/chips/ls74ls11.dart';
import 'package:digital_logic_sim/models/signal_state.dart';

void main() {
  late Chip74LS11 chip;

  setUp(() => chip = Chip74LS11());

  group('Chip74LS11', () {
    test('has correct model number', () {
      expect(chip.model, '74LS11');
    });
    ...
    test('each 3-input AND gate follows the full truth table', () {
      const gates = {
        '门 1': ([1, 2, 13], 12),
        '门 2': ([3, 4, 5], 6),
        '门 3': ([9, 10, 11], 8),
