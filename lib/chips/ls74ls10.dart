...
/// 74LS10 - Triple 3-Input NAND Gate (DIP-14).
///
...
///   Power: VCC(14), GND(7)
class Chip74LS10 extends ChipDefinition {
  @override
  String get model => '74LS10';
  ...
  String get functionSummary =>
      '内含三个独立的 3 输入与非门：只有当三个输入都为高电平时，输出才为'
  ...
  static SignalState _nand3(SignalState a, SignalState b, SignalState c) {
    return SignalState.nand3(a, b, c);
  }
}
