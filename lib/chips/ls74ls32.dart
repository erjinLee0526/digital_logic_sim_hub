...
/// 74LS32 - Quad 2-Input OR Gate (DIP-14).
///
...
///   Power: VCC(14), GND(7)
class Chip74LS32 extends ChipDefinition {
  @override
  String get model => '74LS32';
  ...
  String get functionSummary =>
      '内含四个独立的 2 输入或门：只要任意一个输入为高电平，输出就为'
      '高电平；只有两个输入都为低电平时，输出才为低电平。';
  ...
  Map<int, SignalState> evaluate(
    ...
    return {
      ...
      3: _or(_val(1, inputStates), _val(2, inputStates)),
      // Gate 2: pins 4,5 -> pin 6
      6: _or(_val(4, inputStates), _val(5, inputStates)),
      // Gate 3: pins 9,10 -> pin 8
      8: _or(_val(9, inputStates), _val(10, inputStates)),
      // Gate 4: pins 12,13 -> pin 11
      11: _or(_val(12, inputStates), _val(13, inputStates)),
    };
  }
  ...
  static SignalState _or(SignalState a, SignalState b) {
    return SignalState.or(a, b);
  }
}
