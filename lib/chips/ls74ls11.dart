...
/// 74LS11 - Triple 3-Input AND Gate (DIP-14).
///
...
///   Power: VCC(14), GND(7)
class Chip74LS11 extends ChipDefinition {
  @override
  String get model => '74LS11';
  ...
  String get functionSummary =>
      '内含三个独立的 3 输入与门：只有当三个输入都为高电平时，输出才为'
      '高电平；任意输入为低电平，输出即为低电平。';

  @override
  int get propagationDelayPs => 9000; // ~9ns typical
  ...
  static SignalState _and3(SignalState a, SignalState b, SignalState c) {
    return SignalState.and3(a, b, c);
  }
}
