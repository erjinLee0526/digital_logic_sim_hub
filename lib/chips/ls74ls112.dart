...
/// 74LS112 — Dual Negative-Edge-Triggered J-K Flip-Flop with Preset and
/// Clear (DIP-16).
///
...
class Chip74LS112 extends ChipDefinition {
  @override
  String get model => '74LS112';
  ...
  static const _pins = [
    ...
    PinDefinition(number: 2, label: '1K', direction: PinDirection.input),
    PinDefinition(number: 3, label: '1J', direction: PinDirection.input),
    ...
    PinDefinition(number: 15, label: '~1CLR', direction: PinDirection.input),
    PinDefinition(number: 14, label: '~2CLR', direction: PinDirection.input),
    PinDefinition(number: 13, label: '2CLK', direction: PinDirection.input),
    PinDefinition(number: 12, label: '2K', direction: PinDirection.input),
    PinDefinition(number: 11, label: '2J', direction: PinDirection.input),
  ...
  Map<int, SignalState> evaluate(
    ...
    final ff1 = _evaluateFlipFlop(
      ...
      clear: _val(15, inputStates),
      clock: _val(1, inputStates),
      j: _val(3, inputStates),
      k: _val(2, inputStates),
    ...
    final ff2 = _evaluateFlipFlop(
      ...
      clear: _val(14, inputStates),
      clock: _val(13, inputStates),
      j: _val(11, inputStates),
      k: _val(12, inputStates),
      currentQ: _val(9, inputStates),
      currentQBar: _val(7, inputStates),
      state: state,
    );
